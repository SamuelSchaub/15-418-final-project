...
// ribbon case
// Test test_a2_l3_collapse_edge_ribbon("a2.l3.collapse_edge.ribbon", []() {
// 	Halfedge_Mesh mesh = Halfedge_Mesh::from_indexed_faces({
// 		Vec3(-1.f, -1.f, 0.f), Vec3(-1.f, 1.f, 0.f), Vec3(-1.f, 0.f, 0.f),
...
// 	expect_collapse(mesh, edge, std::nullptr);
// });